	...
	<div>
		<b-carousel id="carousel-1" v-model="slide" :interval="4000" controls indicators background="#ababab"
			...
			<!-- <b-carousel-slide caption="First slide" text="Nulla vitae elit libero, a pharetra augue mollis interdum."
				img-src="https://picsum.photos/1024/180/?image=52"></b-carousel-slide> -->
			...
			<b-carousel-slide img-src="/images/cover1.jpg"></b-carousel-slide>
      <b-carousel-slide img-src="/images/cover2.jpg"></b-carousel-slide>

			<!-- Slides with img slot -->
			<!-- Note the classes .d-block and .img-fluid to prevent browser default image alignment -->
			<!-- <b-carousel-slide>
				<template #img>
					<img class="d-block img-fluid w-100" width="1024" height="180"
						src="https://picsum.photos/1024/180/?image=55" alt="image slot">
				</template>
			</b-carousel-slide> -->
		</b-carousel>
	</div>
